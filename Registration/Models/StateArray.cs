...
namespace Registration.Models
{
    public static class StateArray
    {
        ...
        public static List<US_State> states = new List<US_State> {
        ...
        {
            return states.Select(s => s.Abbreviations).ToList();
        }
        ...
        {
            return states.Where(s => s.Abbreviations.Equals(abbreviation, StringComparison.CurrentCultureIgnoreCase)).Select(s => s.Name).FirstOrDefault();
        }

        public static string GetAbbreviation(string name)
        {
            return states.Where(s => s.Name.Equals(name, StringComparison.CurrentCultureIgnoreCase)).Select(s => s.Abbreviations).FirstOrDefault();
        }

        public static List<US_State> ToList()
        {
